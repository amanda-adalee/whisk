...
class Recipe: Identifiable, ObservableObject {
    ...
    init(id: UUID, name: String, image: String, description: String, ingredients: Array<String>, directions: String, category: [Category], servings: Int, cooktime: Int, dataPublished: String, isFavorite: Bool, recipeUrl: String) {
        self.id = id
        self.name = name
        self.image = image
